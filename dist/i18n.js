...
I18N.en = {
  ...
  '内置 MARD、COCO、漫漫、盼盼、咪小窝等常用店家色号，以及 Perler、Hama、Artkal 国际品牌，共 11 套色板。':'Eleven palettes built in: MARD, COCO, Manman, Panpan and Mixiaowo shop codes, plus Perler, Hama and Artkal.',
...
Object.assign(I18N.en, {
  ...
  '目前支持 11 套色板：MARD 基础 221 色、MARD 完整 291 色、本我粉色精选，以及 COCO、漫漫、盼盼、咪小窝四家常用店家色号，另有 Perler、Hama、Artkal、Artkal Mini 四套国际品牌。在左侧「拼豆色板 / 店家色号」直接点按钮切换，图纸会立刻按该品牌的色号重新生成。':'Eleven palettes: MARD 221, MARD 291, the BENWO pink selection, the COCO, Manman, Panpan and Mixiaowo shop codes, and Perler, Hama, Artkal and Artkal Mini. Pick one under Bead palette on the left and the sheet is rebuilt in that brand’s codes.',
  ...
  '基础色板适合常规材料，完整色板包含扩展色。切换到 COCO、漫漫、盼盼或咪小窝后，同一个颜色会显示成对应店家的色号，照着买豆更方便。粉色精选会改变原图配色，适合自由创作。备料前请核对实体豆色。':'The 221-colour palette suits ordinary stock; the 291 one adds extended colours. Switch to COCO, Manman, Panpan or Mixiaowo and the same colour is shown as that shop’s code, which makes ordering easier. The pink selection deliberately recolours the image. Check real beads before buying.',
...
I18N.ms = {
  ...
  '内置 MARD、COCO、漫漫、盼盼、咪小窝等常用店家色号，以及 Perler、Hama、Artkal 国际品牌，共 11 套色板。':'Sebelas palet terbina dalam: kod kedai MARD, COCO, Manman, Panpan dan Mixiaowo, serta Perler, Hama dan Artkal.',
  ...
  '目前支持 11 套色板：MARD 基础 221 色、MARD 完整 291 色、本我粉色精选，以及 COCO、漫漫、盼盼、咪小窝四家常用店家色号，另有 Perler、Hama、Artkal、Artkal Mini 四套国际品牌。在左侧「拼豆色板 / 店家色号」直接点按钮切换，图纸会立刻按该品牌的色号重新生成。':'Sebelas palet: MARD 221, MARD 291, pilihan merah jambu BENWO, kod kedai COCO, Manman, Panpan dan Mixiaowo, serta Perler, Hama, Artkal dan Artkal Mini. Pilih satu di bawah Palet manik dan helaian dijana semula dalam kod jenama itu.',
  ...
  '基础色板适合常规材料，完整色板包含扩展色。切换到 COCO、漫漫、盼盼或咪小窝后，同一个颜色会显示成对应店家的色号，照着买豆更方便。粉色精选会改变原图配色，适合自由创作。备料前请核对实体豆色。':'Palet 221 warna sesuai untuk stok biasa; yang 291 menambah warna lanjutan. Tukar ke COCO, Manman, Panpan atau Mixiaowo dan warna yang sama dipaparkan sebagai kod kedai itu. Pilihan merah jambu sengaja mengubah warna. Semak manik sebenar sebelum membeli.',
